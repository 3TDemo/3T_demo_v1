...
void Structure::init_structure(
	...
	vector<Point3f>& structure,//保存所有相机的齐次坐标
...
)
{
	...
	//Transform::get_matched_colors(colors_for_all[0], colors_for_all[1], matches_for_all[0], colors, c2);
	...
	//第一个相机设置为世界坐标
	Mat R0 = Mat::eye(3, 3, CV_64FC1);//矩阵规范化
